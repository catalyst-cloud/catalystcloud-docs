...
project and can inform the orchestration engine of any state changes that
...
objects, you are able to inform the orchestration engine of any change in
health. Meaning that if any of the resources your alarm is monitoring where to
experience difficulties your system can react instantly with an automated
process in place that will attempt to heal your resources as soon as the issue
arises.
...
specify the threshold values of what the CPU usage has to meet before you want
to inform the orchestration engine that it needs to scale your instances;
