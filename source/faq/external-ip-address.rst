...
.. code-block:: bash
 ...
 $ nova show my-instance | awk '/network/{ print $6 }'
 150.242.43.13
...
.. code-block:: bash
 ...
 $ neutron router-show border-router | grep external_gateway_info
 | external_gateway_info | {"network_id": "849ab1e9-7ac5-4618-8801-e6176fbbcf30", "enable_snat": true, "external_fixed_ips": [{"subnet_id": "aef23c7c-6c53-4157-8350-d6879c43346c", "ip_address": "150.242.43.12"}]} |
...
.. code-block:: bash
 ...
 $ neutron router-show border-router | awk -F'|' '/external_gateway_info/{ print $3 }' | jq -r '.external_fixed_ips[].ip_address'
 150.242.43.12
