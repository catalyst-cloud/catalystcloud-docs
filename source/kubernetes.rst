...
Kubernetes, to ensure it meets the unique needs in NZ. If you encounter an issue
or have a suggestion on how we can improve it, please raise a ticket via the
`Support Centre`_.
...
**Description:** Time to deploy a cluster is in the vicinity of 15-25 minutes.
